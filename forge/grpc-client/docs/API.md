...
// output
{
  ...
  state: {
    ...
    context: {
      ...
      genesisTime: '2019-12-24T06:36:39.561Z',
      renaissanceTime: '2019-12-24T06:36:39.561Z'
    },
    issuer: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    transferrable: true,
    ttl: 2,
    consumedTime: '2019-12-24T06:36:39.562Z',
    issuer: 'arcblock',
    parent: 'arcblock',
    stake: {
      totalStakes: [Function: BigUint],
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-12-24T06:36:39.562Z',
      renaissanceTime: '2019-12-24T06:36:39.562Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHeight: 5,
    blockTime: '2019-12-24T06:36:39.564Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-12-24T06:36:39.564Z',
      renaissanceTime: '2019-12-24T06:36:39.564Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
result.on('data', data => {
  ...
  state: {
    ...
    tokenSwapConfig: {
      ...
      minCommission: [Function: BigUint],
      maxCommission: [Function: BigUint],
      withdrawInterval: 2,
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHash: Uint8Array [],
    blockHeight: 5,
    blockTime: '2019-12-24T06:36:39.565Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-12-24T06:36:39.565Z',
      renaissanceTime: '2019-12-24T06:36:39.565Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-12-24T06:36:39.566Z',
      renaissanceTime: '2019-12-24T06:36:39.566Z'
    }
  }
}
```
...
```js
const result = await client.getSwapStatistics({
  address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55'
});
...
result.on('data', data => {
  ...
  statistics: {
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    lockedValueOut: [Function: BigUint],
    lockedValueIn: [Function: BigUint],
    lockedAssetsOut: 2,
    lockedAssetsIn: 2
  }
}
  ...
  swap: [
    {
      ...
      context: {
        genesisTx: 'arcblock',
        renaissanceTx: 'arcblock',
        genesisTime: '2019-12-24T06:36:39.568Z',
        renaissanceTime: '2019-12-24T06:36:39.568Z'
      }
    },
    {
      hash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
