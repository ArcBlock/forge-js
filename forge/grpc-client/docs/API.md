...
// output
{
  ...
  state: {
    ...
    context: {
      ...
      genesisTime: '2020-03-25T08:01:46.703Z',
      renaissanceTime: '2020-03-25T08:01:46.703Z'
    },
    issuer: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    transferrable: true,
    ttl: 2,
    consumedTime: '2020-03-25T08:01:46.704Z',
    issuer: 'arcblock',
    parent: 'arcblock',
    stake: {
      totalStakes: [Function: BigUint],
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2020-03-25T08:01:46.704Z',
      renaissanceTime: '2020-03-25T08:01:46.704Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHeight: 5,
    blockTime: '2020-03-25T08:01:46.705Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2020-03-25T08:01:46.705Z',
      renaissanceTime: '2020-03-25T08:01:46.705Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
    ...
    stakeSummary: {
      '2': {
        ...
        context: {
          genesisTx: 'arcblock',
          renaissanceTx: 'arcblock',
          genesisTime: '2020-03-25T08:01:46.706Z',
          renaissanceTime: '2020-03-25T08:01:46.706Z'
        }
      }
    },
    version: 'arcblock',
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHash: Uint8Array [],
    blockHeight: 5,
    blockTime: '2020-03-25T08:01:46.706Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2020-03-25T08:01:46.707Z',
      renaissanceTime: '2020-03-25T08:01:46.707Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
  ...
  swap: [
    {
      ...
      context: {
        genesisTx: 'arcblock',
        renaissanceTx: 'arcblock',
        genesisTime: '2020-03-25T08:01:46.709Z',
        renaissanceTime: '2020-03-25T08:01:46.709Z'
      }
    },
    {
      hash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
