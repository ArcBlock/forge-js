...
proto.forge_abi.RequestGetSwapState = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.forge_abi.RequestGetSwapState.repeatedFields_,
    null
  );
};
...
proto.forge_abi.ResponseGetSwapState.prototype.getState = function() {
  return /** @type{?proto.forge_abi.SwapState} */ (jspb.Message.getWrapperField(
    this,
    state_pb.SwapState,
    2
  ));
...
proto.forge_abi.RequestGetDelegateState = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.forge_abi.RequestGetDelegateState.repeatedFields_,
    null
  );
};
...
proto.forge_abi.ResponseGetDelegateState.prototype.getState = function() {
  return /** @type{?proto.forge_abi.DelegateState} */ (jspb.Message.getWrapperField(
    this,
    state_pb.DelegateState,
    2
  ));
};
  ...
  proto.forge_abi.ResponseSubscribe.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        ...
        activateProtocol:
          (f = msg.getActivateProtocol()) && type_pb.Transaction.toObject(includeInstance, f),
        deactivateProtocol:
          (f = msg.getDeactivateProtocol()) && type_pb.Transaction.toObject(includeInstance, f),
        revokeDelegate:
          (f = msg.getRevokeDelegate()) && type_pb.Transaction.toObject(includeInstance, f),
        depositToken:
          (f = msg.getDepositToken()) && type_pb.Transaction.toObject(includeInstance, f),
        withdrawToken:
          (f = msg.getWithdrawToken()) && type_pb.Transaction.toObject(includeInstance, f),
        approveWithdraw:
          (f = msg.getApproveWithdraw()) && type_pb.Transaction.toObject(includeInstance, f),
        revokeWithdraw:
          (f = msg.getRevokeWithdraw()) && type_pb.Transaction.toObject(includeInstance, f),
        accountState:
        ...
        delegateState:
          (f = msg.getDelegateState()) && state_pb.DelegateState.toObject(includeInstance, f),
      };
...
proto.forge_abi.ResponseSubscribe.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(26, f, type_pb.Transaction.serializeBinaryToWriter);
  }
  f = message.getDeactivateProtocol();
  if (f != null) {
    writer.writeMessage(27, f, type_pb.Transaction.serializeBinaryToWriter);
  }
...
proto.forge_abi.ResponseListTethers = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.forge_abi.ResponseListTethers.repeatedFields_,
    null
  );
};
  ...
  proto.forge_abi.ResponseListTethers.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        code: jspb.Message.getFieldWithDefault(msg, 1, 0),
        page: (f = msg.getPage()) && trace_type_pb.PageInfo.toObject(includeInstance, f),
        tethersList: jspb.Message.toObjectList(
          msg.getTethersList(),
          state_pb.TetherState.toObject,
          includeInstance
        ),
      };
...
proto.forge_abi.ResponseListTethers.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, state_pb.TetherState.serializeBinaryToWriter);
  }
};
...
proto.forge_abi.ResponseListTethers.prototype.getTethersList = function() {
  return /** @type{!Array<!proto.forge_abi.TetherState>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    state_pb.TetherState,
    3
  ));
...
proto.forge_abi.ResponseListSwap = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.forge_abi.ResponseListSwap.repeatedFields_,
    null
  );
};
  ...
  proto.forge_abi.ResponseListSwap.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        code: jspb.Message.getFieldWithDefault(msg, 1, 0),
        page: (f = msg.getPage()) && trace_type_pb.PageInfo.toObject(includeInstance, f),
        swapList: jspb.Message.toObjectList(
          msg.getSwapList(),
          state_pb.SwapState.toObject,
          includeInstance
        ),
      };
