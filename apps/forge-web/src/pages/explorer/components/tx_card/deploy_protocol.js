...
const DeployProtocolTx = React.memo(({ tx, theme, ...rest }) => (
  <Container {...rest}>
    ...
    <div className="info-row">
      <Tooltip title="Deploy Protocol" placement="top">
        <IconFa
          name="code"
          size={14}
          rounded={true}
...
DeployProtocolTx.propTypes = {
  tx: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withTheme()(DeployProtocolTx);
