  ...
  proto.forge_abi.AccountState.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        ...
        genesisTx: jspb.Message.getFieldWithDefault(msg, 9, ''),
        renaissanceTx: jspb.Message.getFieldWithDefault(msg, 10, ''),
        genesisTime:
...
/**
 * optional string renaissance_tx = 10;
 * @return {string}
 */
...
proto.forge_abi.ForgeState.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getData();
  if (f != null) {
    writer.writeMessage(14, f, google_protobuf_any_pb.Any.serializeBinaryToWriter);
  }
};
...
/**
 * map<uint64, UpgradeTasks> tasks = 13;
