 ...
 * @const
 */
proto.forge_abi.ResponseSubscribe.oneofGroups_ = [[2,3,4,5,6,7,8,16,17,19,20,21,22,23,129,130,131,132]];
...
proto.forge_abi.ResponseSubscribe.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    accountUpgrade: (f = msg.getAccountUpgrade()) && type_pb.Transaction.toObject(includeInstance, f),
