...
proto.forge_abi.RequestGetChannelState = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.forge_abi.RequestGetChannelState.repeatedFields_, null);
};
...
proto.forge_abi.ResponseGetChannelState.prototype.getState = function() {
  return /** @type{?proto.forge_abi.ChannelState} */ (
    jspb.Message.getWrapperField(this, state_pb.ChannelState, 2));
};
...
proto.forge_abi.ResponseGetUnconfirmedTxs.prototype.getUnconfirmedTxs = function() {
  return /** @type{?proto.forge_abi.UnconfirmedTxs} */ (
    jspb.Message.getWrapperField(this, type_pb.UnconfirmedTxs, 2));
};
...
proto.forge_abi.ResponseSubscribe.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    accountState: (f = msg.getAccountState()) && type_pb.Transaction.toObject(includeInstance, f),
    assetState: (f = msg.getAssetState()) && type_pb.Transaction.toObject(includeInstance, f),
    channelState: (f = msg.getChannelState()) && type_pb.Transaction.toObject(includeInstance, f),
...
proto.forge_abi.ResponseSubscribe.prototype.getAccountState = function() {
  return /** @type{?proto.forge_abi.Transaction} */ (
    jspb.Message.getWrapperField(this, type_pb.Transaction, 129));
};
...
proto.forge_abi.ResponseSubscribe.prototype.getAssetState = function() {
  return /** @type{?proto.forge_abi.Transaction} */ (
    jspb.Message.getWrapperField(this, type_pb.Transaction, 130));
};
...
proto.forge_abi.ResponseSubscribe.prototype.getChannelState = function() {
  return /** @type{?proto.forge_abi.Transaction} */ (
    jspb.Message.getWrapperField(this, type_pb.Transaction, 131));
};
...
proto.forge_abi.ResponseSubscribe.prototype.getForgeState = function() {
  return /** @type{?proto.forge_abi.Transaction} */ (
    jspb.Message.getWrapperField(this, type_pb.Transaction, 132));
};
...
proto.forge_abi.ResponseSubscribe.prototype.getStakeState = function() {
  return /** @type{?proto.forge_abi.Transaction} */ (
    jspb.Message.getWrapperField(this, type_pb.Transaction, 133));
};
