...
sendDeclareFileTx(param: GraphQLClient.TxParam<GraphQLClient.DeclareFileTx>): Promise<GraphQLClient.ResponseSendTx>;
...
encodeDeclareFileTx(param: GraphQLClient.TxParam<GraphQLClient.DeclareFileTx>): Promise<GraphQLClient.EncodeTxResult>;
...
export type Itx = GraphQLClient.UpdateAssetTx | GraphQLClient.TransferTx | GraphQLClient.SysUpgradeTx | GraphQLClient.StakeTx | GraphQLClient.ExchangeTx | GraphQLClient.DeclareFileTx | GraphQLClient.DeclareTx | GraphQLClient.CreateAssetTx | GraphQLClient.ConsumeAssetTx | GraphQLClient.ConsensusUpgradeTx | GraphQLClient.PokeTx | GraphQLClient.AccountMigrateTx;
