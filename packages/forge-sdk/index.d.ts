...
listWallet(request: forge_abi.RequestListWallet): GRpcClient.StreamResult<forge_abi.ResponseListWallet>;
removeWallet(request: forge_abi.RequestRemoveWallet): GRpcClient.UnaryResult<forge_abi.ResponseRemoveWallet>;
...
listTethers(request: forge_abi.RequestListTethers): GRpcClient.UnaryResult<forge_abi.ResponseListTethers>;
listSwap(request: forge_abi.RequestListSwap): GRpcClient.UnaryResult<forge_abi.ResponseListSwap>;
encodeConsensusUpgradeTx(param: GRpcClient.TxParam<GRpcClient.ConsensusUpgradeTx>): Promise<GRpcClient.ResponseSendTx>;
encodeDeployProtocolTx(param: GRpcClient.TxParam<GRpcClient.DeployProtocolTx>): Promise<GRpcClient.ResponseSendTx>;
encodeSysUpgradeTx(param: GRpcClient.TxParam<GRpcClient.SysUpgradeTx>): Promise<GRpcClient.ResponseSendTx>;
encodeAccountMigrateTx(param: GRpcClient.TxParam<GRpcClient.AccountMigrateTx>): Promise<GRpcClient.ResponseSendTx>;
...
encodeDeclareTx(param: GRpcClient.TxParam<GRpcClient.DeclareTx>): Promise<GRpcClient.ResponseSendTx>;
encodeDelegateTx(param: GRpcClient.TxParam<GRpcClient.DelegateTx>): Promise<GRpcClient.ResponseSendTx>;
encodeDepositTetherTx(param: GRpcClient.TxParam<GRpcClient.DepositTetherTx>): Promise<GRpcClient.ResponseSendTx>;
encodeDepositTokenTx(param: GRpcClient.TxParam<GRpcClient.DepositTokenTx>): Promise<GRpcClient.ResponseSendTx>;
encodeExchangeTetherTx(param: GRpcClient.TxParam<GRpcClient.ExchangeTetherTx>): Promise<GRpcClient.ResponseSendTx>;
encodeExchangeTx(param: GRpcClient.TxParam<GRpcClient.ExchangeTx>): Promise<GRpcClient.ResponseSendTx>;
...
sendAccountMigrateTx(param: GRpcClient.TxParam<GRpcClient.AccountMigrateTx>): Promise<GRpcClient.EncodeTxResult>;
...
sendDeclareTx(param: GRpcClient.TxParam<GRpcClient.DeclareTx>): Promise<GRpcClient.EncodeTxResult>;
sendDelegateTx(param: GRpcClient.TxParam<GRpcClient.DelegateTx>): Promise<GRpcClient.EncodeTxResult>;
sendDepositTetherTx(param: GRpcClient.TxParam<GRpcClient.DepositTetherTx>): Promise<GRpcClient.EncodeTxResult>;
sendDepositTokenTx(param: GRpcClient.TxParam<GRpcClient.DepositTokenTx>): Promise<GRpcClient.EncodeTxResult>;
sendExchangeTetherTx(param: GRpcClient.TxParam<GRpcClient.ExchangeTetherTx>): Promise<GRpcClient.EncodeTxResult>;
sendExchangeTx(param: GRpcClient.TxParam<GRpcClient.ExchangeTx>): Promise<GRpcClient.EncodeTxResult>;
...
signAccountMigrateTx(param: GRpcClient.TxParam<GRpcClient.AccountMigrateTx>): Promise<GRpcClient.Transaction>;
...
signDepositTetherTx(param: GRpcClient.TxParam<GRpcClient.DepositTetherTx>): Promise<GRpcClient.Transaction>;
signDepositTokenTx(param: GRpcClient.TxParam<GRpcClient.DepositTokenTx>): Promise<GRpcClient.Transaction>;
signExchangeTetherTx(param: GRpcClient.TxParam<GRpcClient.ExchangeTetherTx>): Promise<GRpcClient.Transaction>;
...
multiSignExchangeTx(param: GRpcClient.TxParam<GRpcClient.ExchangeTx>): Promise<GRpcClient.Transaction>;
...
sendDepositTetherTx(param: GraphQLClient.TxParam<GraphQLClient.DepositTetherTx>): Promise<GraphQLClient.ResponseSendTx>;
sendDepositTokenTx(param: GraphQLClient.TxParam<GraphQLClient.DepositTokenTx>): Promise<GraphQLClient.ResponseSendTx>;
sendExchangeTetherTx(param: GraphQLClient.TxParam<GraphQLClient.ExchangeTetherTx>): Promise<GraphQLClient.ResponseSendTx>;
...
encodeDepositTetherTx(param: GraphQLClient.TxParam<GraphQLClient.DepositTetherTx>): Promise<GraphQLClient.EncodeTxResult>;
encodeDepositTokenTx(param: GraphQLClient.TxParam<GraphQLClient.DepositTokenTx>): Promise<GraphQLClient.EncodeTxResult>;
encodeExchangeTetherTx(param: GraphQLClient.TxParam<GraphQLClient.ExchangeTetherTx>): Promise<GraphQLClient.EncodeTxResult>;
...
signDepositTetherTx(param: GraphQLClient.TxParam<GraphQLClient.DepositTetherTx>): Promise<GraphQLClient.Transaction>;
signDepositTokenTx(param: GraphQLClient.TxParam<GraphQLClient.DepositTokenTx>): Promise<GraphQLClient.Transaction>;
signExchangeTetherTx(param: GraphQLClient.TxParam<GraphQLClient.ExchangeTetherTx>): Promise<GraphQLClient.Transaction>;
