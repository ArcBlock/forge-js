...
declare class RpcClient {
   ...
   * @memberof RpcClient
   */
  listRpcMethods(): _@arcblockGrpcRpcClient.T100;
  /**
   * List standard rpc methods
   *
   * @returns Object
   * @memberof RpcClient
   */
  listTxMethods(): _@arcblockGrpcRpcClient.T100;
}
...
declare const _@arcblockGrpcRpcClient: _@arcblockGrpcRpcClient.T101;
declare namespace _@arcblockGrpcRpcClient {
...
export = _@arcblockGrpcRpcClient;
