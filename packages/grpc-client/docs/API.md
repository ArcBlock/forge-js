...
// output
{
  ...
  state: {
    ...
    context: {
      ...
      genesisTime: '2019-05-31T23:01:59.616Z',
      renaissanceTime: '2019-05-31T23:01:59.616Z'
    },
    issuer: 'arcblock',
    migratedTo: [
      'arcblock',
...
// output
{
  ...
  state: {
    ...
    transferrable: true,
    ttl: 2,
    consumedTime: '2019-05-31T23:01:59.616Z',
    issuer: 'arcblock',
    parent: 'arcblock',
    stake: {
      totalStakes: [Function: BigUint],
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHeight: 5,
    blockTime: '2019-05-31T23:01:59.618Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
    ...
    stakeSummary: {
      '2': {
        ...
        context: {
          genesisTx: 'arcblock',
          renaissanceTx: 'arcblock',
          genesisTime: '2019-05-31T23:01:59.618Z',
          renaissanceTime: '2019-05-31T23:01:59.618Z'
        }
      }
    },
    version: 'arcblock',
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHash: Uint8Array [],
    blockHeight: 5,
    blockTime: '2019-05-31T23:01:59.619Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-05-31T23:01:59.619Z',
      renaissanceTime: '2019-05-31T23:01:59.619Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-05-31T23:01:59.620Z',
      renaissanceTime: '2019-05-31T23:01:59.620Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
// output
{
  ...
  state: {
    ...
    target: 'arcblock',
    locktime: '2019-05-31T23:01:59.620Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55'
  }
}
```
  ...
  tethers: [
    {
      ...
      charge: [Function: BigUint],
      target: 'arcblock',
      locktime: '2019-05-31T23:01:59.621Z',
      address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55'
    },
    {
      hash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
