...
// output
{
  ...
  state: {
    ...
    context: {
      ...
      genesisTime: '2019-10-08T05:45:11.885Z',
      renaissanceTime: '2019-10-08T05:45:11.885Z'
    },
    issuer: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    transferrable: true,
    ttl: 2,
    consumedTime: '2019-10-08T05:45:11.886Z',
    issuer: 'arcblock',
    parent: 'arcblock',
    stake: {
      totalStakes: [Function: BigUint],
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-10-08T05:45:11.886Z',
      renaissanceTime: '2019-10-08T05:45:11.886Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHeight: 5,
    blockTime: '2019-10-08T05:45:11.888Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-10-08T05:45:11.888Z',
      renaissanceTime: '2019-10-08T05:45:11.888Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHash: Uint8Array [],
    blockHeight: 5,
    blockTime: '2019-10-08T05:45:11.889Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-10-08T05:45:11.889Z',
      renaissanceTime: '2019-10-08T05:45:11.889Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-10-08T05:45:11.890Z',
      renaissanceTime: '2019-10-08T05:45:11.890Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
// output
{
  ...
  state: {
    ...
    target: 'arcblock',
    locktime: '2019-10-08T05:45:11.890Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55'
  }
}
```
  ...
  swap: [
    {
      ...
      context: {
        genesisTx: 'arcblock',
        renaissanceTx: 'arcblock',
        genesisTime: '2019-10-08T05:45:11.892Z',
        renaissanceTime: '2019-10-08T05:45:11.892Z'
      }
    },
    {
      hash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
  ...
  tethers: [
    {
      ...
      charge: [Function: BigUint],
      target: 'arcblock',
      locktime: '2019-10-08T05:45:11.892Z',
      address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55'
    },
    {
      hash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
