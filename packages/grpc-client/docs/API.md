...
// output
{
  ...
  state: {
    ...
    context: {
      ...
      genesisTime: '2019-04-30T08:11:50.278Z',
      renaissanceTime: '2019-04-30T08:11:50.278Z'
    },
    issuer: 'arcblock',
    migratedTo: [
      'arcblock',
...
// output
{
  ...
  state: {
    ...
    transferrable: true,
    ttl: 2,
    consumedTime: '2019-04-30T08:11:50.278Z',
    issuer: 'arcblock',
    stake: {
      totalStakes: [Function: BigUint],
      totalUnstakes: [Function: BigUint],
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHeight: 5,
    blockTime: '2019-04-30T08:11:50.279Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
    ...
    stakeSummary: {
      '2': {
        ...
        context: {
          genesisTx: 'arcblock',
          renaissanceTx: 'arcblock',
          genesisTime: '2019-04-30T08:11:50.280Z',
          renaissanceTime: '2019-04-30T08:11:50.280Z'
        }
      }
    },
    version: 'arcblock',
...
result.on('data', data => {
  ...
  info: {
    ...
    blockHash: Uint8Array [],
    blockHeight: 5,
    blockTime: '2019-04-30T08:11:50.280Z',
    address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
    votingPower: 5,
    totalTxs: 5,
    version: 'arcblock',
...
// output
{
  ...
  state: {
    ...
    context: {
      genesisTx: 'arcblock',
      renaissanceTx: 'arcblock',
      genesisTime: '2019-04-30T08:11:50.281Z',
      renaissanceTime: '2019-04-30T08:11:50.281Z'
    },
    data: {
      type: 'string',
      value: 'ABCD 1234'
...
const stream = client.process({
  verifyTx: {
    ...
    states: [
      {
        ...
        context: {
          genesisTx: 'arcblock',
          renaissanceTx: 'arcblock',
          genesisTime: '2019-04-30T08:11:50.283Z',
          renaissanceTime: '2019-04-30T08:11:50.283Z'
        },
        issuer: 'arcblock',
        migratedTo: [
          'arcblock',
    ...
    assets: [
      {
        ...
        transferrable: true,
        ttl: 2,
        consumedTime: '2019-04-30T08:11:50.283Z',
        issuer: 'arcblock',
        stake: {
          totalStakes: [Function: BigUint],
          totalUnstakes: [Function: BigUint],
    ...
    context: {
      txHash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
      blockHeight: 5,
      blockTime: '2019-04-30T08:11:50.283Z',
      totalTxs: 5,
      txStatistics: {
      ...
      txIndex: 2,
      lastBlockTime: '2019-04-30T08:11:50.283Z'
    },
    appState: {
      address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
      consensus: {
...
const result = await client.processOne({
  verifyTx: {
    ...
    states: [
      ...
      },
      {
        ...
        context: {
          genesisTx: 'arcblock',
          renaissanceTx: 'arcblock',
          genesisTime: '2019-04-30T08:11:50.284Z',
          renaissanceTime: '2019-04-30T08:11:50.284Z'
        },
        issuer: 'arcblock',
        migratedTo: [
          'arcblock',
    ...
    assets: [
      {
        ...
        transferrable: true,
        ttl: 2,
        consumedTime: '2019-04-30T08:11:50.284Z',
        issuer: 'arcblock',
        stake: {
          totalStakes: [Function: BigUint],
          totalUnstakes: [Function: BigUint],
    ...
    context: {
      txHash: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
      blockHeight: 5,
      blockTime: '2019-04-30T08:11:50.284Z',
      totalTxs: 5,
      txStatistics: {
        numAccountMigrateTxs: 5,
        numCreateAssetTxs: 5,
      ...
      txIndex: 2,
      lastBlockTime: '2019-04-30T08:11:50.284Z'
    },
    appState: {
      address: 'F2D072CBD4954A20F26280730795D91AC1039996CEB6E24A31E9CE548DCB5E55',
      consensus: {
